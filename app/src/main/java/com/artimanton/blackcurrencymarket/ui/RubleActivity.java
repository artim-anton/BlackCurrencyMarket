...
public class RubleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ruble);
        load_city();
    ...
    public void load_city(){
        ...
        reference = database.getReference(setting_country + "/" + setting_city + "/" + "ruble");
